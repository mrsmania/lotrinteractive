...
export const PLACES: Record<string, Place> = {
  grauhafen: { name: "Die Grauen Anfurten", shortName: "Graue Anfurten", x: 484.4, y: 236.5 },
  lindon: { name: "Lindon", x: 416.7, y: 239.6 },
  beutelsend: { name: "Hobbingen und Beutelsend", shortName: "Hobbingen", x: 574, y: 230.2 },
  bockland: { name: "Bockland", x: 631.2, y: 258.3 },
  tuckborn: { name: "Tuckborn", x: 581.2, y: 257.3 },
  alterwald: { name: "Der Alte Wald", x: 647.9, y: 253.1 },
  huegelgraeber: { name: "Hügelgräberhöhen", shortName: "Hügelgräber", x: 666.7, y: 265 },
  bree: { name: "Bree", x: 674, y: 239.6 },
  wetterspitze: { name: "Wetterspitze", x: 724, y: 236.5 },
  trollhoehen: { name: "Trollhöhen", x: 791.7, y: 203.1 },
  bruchtal: { name: "Bruchtal", x: 815.6, y: 233.3 },
  carn_dum: { name: "Carn Dûm in Angmar", shortName: "Carn Dûm", x: 677.1, y: 74 },
  gundabad: { name: "Gundabad", x: 822.9, y: 89.6 },
  hohepass: { name: "Der Hohe Pass", x: 843.8, y: 227.1 },
  ...
  duesterwald: { name: "Das Waldlandreich", shortName: "Waldlandreich", x: 962.5, y: 187.5 },
  dolguldur: { name: "Dol Guldur", x: 968.8, y: 328.8 },
  erebor: { name: "Erebor, der Einsame Berg", shortName: "Erebor", x: 1069.6, y: 192.7 },
  thal: { name: "Thal", x: 1076, y: 212.5 },
  esgaroth: { name: "Esgaroth am See", shortName: "Esgaroth", x: 1066.7, y: 239.6 },
  eisenberge: { name: "Die Eisenberge", x: 1270.8, y: 166.7 },
  fangorn: { name: "Fangorn", x: 847.9, y: 395.8 },
  isengart: { name: "Isengart und Orthanc", shortName: "Isengart", x: 765.8, y: 420.8 },
  helmsklamm: { name: "Helms Klamm", x: 782.3, y: 471.2 },
  edoras: { name: "Edoras", x: 825.8, y: 487.5 },
  dunharg: { name: "Dunharg und die Pfade der Toten", shortName: "Dunharg", x: 835.4, y: 504.2 },
  ...
  totensuempfe: { name: "Die Totensümpfe", shortName: "Totensümpfe", x: 988.5, y: 456.2 },
